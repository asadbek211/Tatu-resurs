...
import kotlinx.android.synthetic.main.fragment_payshanba.*

class PayshanbaFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_payshanba, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val prefs1: SharedPreferences =
            requireActivity().getSharedPreferences("p_fan1", Context.MODE_PRIVATE)
        val prefs2: SharedPreferences =
            requireActivity().getSharedPreferences("p_fan2", Context.MODE_PRIVATE)
        val prefs3: SharedPreferences =
            requireActivity().getSharedPreferences("p_fan3", Context.MODE_PRIVATE)
        val prefs4: SharedPreferences =
            requireActivity().getSharedPreferences("p_fan4", Context.MODE_PRIVATE)
        val fan1 = prefs1.getInt("p_fan1", 0)
        val fan2 = prefs2.getInt("p_fan2", 0)
        val fan3 = prefs3.getInt("p_fan3", 0)
        val fan4 = prefs4.getInt("p_fan4", 0)
