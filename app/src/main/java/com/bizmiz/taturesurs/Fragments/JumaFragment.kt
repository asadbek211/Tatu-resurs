...
import kotlinx.android.synthetic.main.fragment_juma.*

class JumaFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val prefs1: SharedPreferences =
            requireActivity().getSharedPreferences("j_fan1", Context.MODE_PRIVATE)
        val prefs2: SharedPreferences =
            requireActivity().getSharedPreferences("j_fan2", Context.MODE_PRIVATE)
        val prefs3: SharedPreferences =
            requireActivity().getSharedPreferences("j_fan3", Context.MODE_PRIVATE)
        val prefs4: SharedPreferences =
            requireActivity().getSharedPreferences("j_fan4", Context.MODE_PRIVATE)
        val fan1 = prefs1.getInt("j_fan1", 0)
        val fan2 = prefs2.getInt("j_fan2", 0)
        val fan3 = prefs3.getInt("j_fan3", 0)
        val fan4 = prefs4.getInt("j_fan4", 0)
