...
import kotlinx.android.synthetic.main.fragment_dushanba.*

class DushanbaFragment : Fragment() {
    var fanlar:Array<String> = arrayOf()
    private val toast:String = "Bunday fan mavjud emas \nSozlamalar bo'limidan dars jadvalini ko'rib chiqing"
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_dushanba, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val prefs1: SharedPreferences = requireActivity().getSharedPreferences(
            "d_fan1",
            Context.MODE_PRIVATE
        )
        val prefs2: SharedPreferences = requireActivity().getSharedPreferences(
            "d_fan2",
            Context.MODE_PRIVATE
        )
        val prefs3: SharedPreferences = requireActivity().getSharedPreferences(
            "d_fan3",
            Context.MODE_PRIVATE
        )
        val prefs4: SharedPreferences = requireActivity().getSharedPreferences(
            "d_fan4",
            Context.MODE_PRIVATE
        )
        val fan1 = prefs1.getInt("d_fan1", 0)
        val fan2 = prefs2.getInt("d_fan2", 0)
        val fan3 = prefs3.getInt("d_fan3", 0)
        val fan4 = prefs4.getInt("d_fan4", 0)
